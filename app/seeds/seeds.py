...
def seed_all():
    ...
    equip_list = [
...

        {
         ...
         'name': 'Birthright',
         'rarity': 'Very Rare Clothing',
         'description': 'Description: Everyone looks better in a pointy hat.',
...

        {
         ...
         'rarity': 'Rare Amulet',
         'description': 'Description: Advantage with Wisdom Saving Throws.',
         'modifiers': 'Shield',
         'damage': None,
         'damage_bonus': None,
         'damage_type': None
    ...
    build_classes_list = [
        ...
        { 'build_id': 2, 'class_id': 8, 'name': 'Ranger', 'modifier': 'dexterity', 'level': 5, 'sub_class': 'Gloomstalker', 'order': 1},
        { 'build_id': 3, 'class_id': 8, 'name': 'Ranger', 'modifier': 'dexterity', 'level': 5, 'sub_class': 'Gloomstalker', 'order': 1},
        { 'build_id': 4, 'class_id': 8, 'name': 'Ranger', 'modifier': 'dexterity', 'level': 5, 'sub_class': 'Gloomstalker', 'order': 1},
    ]
