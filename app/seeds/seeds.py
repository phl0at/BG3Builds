...
def seed_all():
    ...
    cantrip_list = [
        ...
        },
        {
            'name': 'Minor Illusion',
            'school': 'Illusion',
            'description': 'Create an illusion that compels nearby creatures to investigate. You can remain hidden while casting this spell and can cast it while silenced.',
            'duration': 10,
            'range': 18,
            'radius': None,
            'attack_save': None,
        ...
        },
        {
            'name': 'Poison Spray',
            'school': 'Conjuration',
            'description': 'Project a puff of noxious gas, dealing 1d12 Poison damage to a target.',
            'duration': 10,
            'range': 3,
            'radius': None,
            'attack_save': 'con',
        ...
        },
        {
            'name': 'Produce Flame',
            'school': 'Conjuration',
            'description': 'A flame in your hand sheds a light in a  9m radius and deals 1d8 Fire damage when thrown.',
            'duration': 11,
            'range': 9,
            'radius': None,
            'attack_save': 'atk',
        ...
        },
        {
            'name': 'Ray of Frost',
            'school': 'Evocation',
            'description': "Blast a target with frigid ice, reducing their Movement Speed by 3m.",
            'duration': 0,
            'range': 18,
            'radius': None,
            'attack_save': 'atk',
        ...
        },
        {
            ...
            'description': 'Your staff or club becomes magical: it deals 1d8 (+Wisdom modifier) Bludgeoning damage, and uses your Spellcasting Ability for Attack rolls.',
            'duration': 10,
            'range': 0,
            'radius': None,
            'attack_save': None,
        ...
        },
        {
            'name': 'Shocking Grasp',
            'school': 'Evocation',
            'description': 'Touch a nearby target with an electric grip, preventing the use of Reactions. This spell has Advantage on creatures with metal Armour.',
            'duration': 1,
            'range': 1.5,
            'radius': None,
            'attack_save': 'atk',
        ...
        },
        {
            'name': 'Thorn Whip',
            'school': 'Transmutation',
            'description': 'Pulls the creature 3m closer to you.',
            'duration': None,
            'range': 9,
            'radius': None,
            'attack_save': 'atk',
        ...
        },
        {
            'name': 'True Strike',
            'school': 'Divination',
            'description': 'Gain Advantage on your next Attack roll against the target.',
            'duration': 2,
            'range': 18,
            'radius': None,
            'attack_save': None,
        ...
        },
        {
            ...
            'school': 'Divination',
            'description': 'Insult a creature, causing it to have Disadvantage on its next Attack roll.',
            'duration': 1,
            'range': 18,
            'radius': None,
            'attack_save': 'wis',
