...
// and then export them in objects - as opposed to doing fetch requests to a public API or web scraping a wiki.
...
import TheDarkUrge from "../../../../images/char_icons/DarkUrge.png";
...
export const errorImage = { Sadowheart };
